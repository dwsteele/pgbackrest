...
testRun(void)
{
    ...
    if (testBegin("cmdBackup() and verifyProcess()"))
    {
        ...
        TEST_RESULT_LOG(
            ...
            "P01 DETAIL: backup file " TEST_PATH "/pg1/base/1/2 (bundle 1/0, 256KB, 91.43%) checksum [SHA1]\n"
            "P01 DETAIL: backup file " TEST_PATH "/pg1/base/1/44 (bundle 1/475, 16KB, 97.14%) checksum [SHA1]\n"
            "P01 DETAIL: backup file " TEST_PATH "/pg1/global/pg_control (bundle 1/534, 8KB, 100.00%) checksum [SHA1]\n"
            "P01 DETAIL: backup file " TEST_PATH "/pg1/PG_VERSION (bundle 1/624, 2B, 100.00%) checksum [SHA1]\n"
        ...
        TEST_RESULT_LOG(
            ...
            "P01 DETAIL: backup file " TEST_PATH "/pg1/global/pg_control (bundle 1/236, 8KB, 100.00%) checksum [SHA1]\n"
