...
testRun(void)
{
    ...
    if (testBegin("bldCfgParse() and bldCfgRender()"))
    {
        ...
        TEST_STORAGE_GET(
            ...
            "    PARSE_RULE_STRPUB(\"16384\"),\n"
            "    PARSE_RULE_STRPUB(\"20\"),\n"
            "    PARSE_RULE_STRPUB(\"30\"),\n"
            "    PARSE_RULE_STRPUB(\"32768\"),\n"
            "    PARSE_RULE_STRPUB(\"5\"),\n"
            "    PARSE_RULE_STRPUB(\"50\"),\n"
            "    PARSE_RULE_STRPUB(\"6\"),\n"
            "    PARSE_RULE_STRPUB(\"8192\"),\n"
            "    PARSE_RULE_STRPUB(\"9\"),\n"
            ...
            "    parseRuleValStrQT_16384_QT,\n"
            "    parseRuleValStrQT_20_QT,\n"
            "    parseRuleValStrQT_30_QT,\n"
            "    parseRuleValStrQT_32768_QT,\n"
            "    parseRuleValStrQT_5_QT,\n"
            "    parseRuleValStrQT_50_QT,\n"
            "    parseRuleValStrQT_6_QT,\n"
            "    parseRuleValStrQT_8192_QT,\n"
            ...
            "typedef enum\n"
            "{\n"
            "    parseRuleValSize8192,\n"
            "    parseRuleValSize16384,\n"
            "    parseRuleValSize32768,\n"
            "} ParseRuleValueSize;\n"
            "\n"
            COMMENT_BLOCK_BEGIN "\n"
            "Rule Times\n"
            ...
            "                PARSE_RULE_OPTIONAL_ALLOW_LIST\n"
            "                (\n"
            "                    PARSE_RULE_VAL_SIZE(8192),\n"
            "                    PARSE_RULE_VAL_SIZE(16384),\n"
            ...
            "                PARSE_RULE_OPTIONAL_ALLOW_RANGE\n"
            "                (\n"
            "                    PARSE_RULE_VAL_TIME(5),\n"
            "                    PARSE_RULE_VAL_TIME(50),\n"
            "                ),\n"
            "\n"
            "                PARSE_RULE_OPTIONAL_DEFAULT\n"
            "                (\n"
            "                    PARSE_RULE_VAL_TIME(30),\n"
            "                ),\n"
            "            ),\n"
            "\n"
            "            PARSE_RULE_OPTIONAL_GROUP\n"
