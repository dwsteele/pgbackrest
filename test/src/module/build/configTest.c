...
testRun(void)
{
    ...
    if (testBegin("bldCfgParse() and bldCfgRender()"))
    {
        ...
        TEST_STORAGE_GET(
            ...
            "                        PARSE_RULE_VAL_INT(parseRuleValInt9),\n"
            "                        PARSE_RULE_VAL_STR(parseRuleValStrQT_9_QT),\n"
            "                        PARSE_RULE_VAL_STRID(parseRuleValStrIdGz),\n"
            "                        PARSE_RULE_VAL_INT(parseRuleValInt6),\n"
            "                        PARSE_RULE_VAL_STR(parseRuleValStrQT_6_QT),\n"
            "                    ),\n"
            "                ),\n"
            "            ),\n"
            "\n"
            ...
            "                PARSE_RULE_OPTIONAL_ALLOW_LIST\n"
            "                (\n"
            "                    PARSE_RULE_VAL_STR(parseRuleValStrnone),\n"
            "                    PARSE_RULE_VAL_STR(parseRuleValStrbz2),\n"
            "                    PARSE_RULE_VAL_STR(parseRuleValStrgz),\n"
            "                ),\n"
            "\n"
            "                PARSE_RULE_OPTIONAL_DEFAULT\n"
            "                (\n"
